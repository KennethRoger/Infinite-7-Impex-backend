...
function createProductCategoryRoutes(productCategoryController) {
    ...
    router.get('/', (0, cache_control_1.publicCache)(15), (req, res, next) => productCategoryController.getAllCategories(req, res, next));
    router.get('/:id', (0, cache_control_1.publicCache)(15), (req, res, next) => productCategoryController.getCategoryById(req, res, next));
