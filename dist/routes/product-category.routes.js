...
function createProductCategoryRoutes(productCategoryController) {
    ...
    router.get('/', (req, res, next) => productCategoryController.getAllCategories(req, res, next));
    router.get('/:id', (req, res, next) => productCategoryController.getCategoryById(req, res, next));
