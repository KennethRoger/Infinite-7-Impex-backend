...
function createBlogRoutes(blogController) {
    ...
    router.get('/', (0, cache_control_1.publicCache)(120), (req, res, next) => blogController.getAllBlogs(req, res, next));
    router.get('/:id', (0, cache_control_1.publicCache)(120), (req, res, next) => blogController.getBlogById(req, res, next));
