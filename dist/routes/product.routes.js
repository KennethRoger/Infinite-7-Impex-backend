...
function createProductRoutes(productController) {
    ...
    router.get('/', (0, cache_control_1.publicCache)(120), (req, res, next) => productController.getAllProducts(req, res, next));
    router.get('/:id', (0, cache_control_1.publicCache)(120), (req, res, next) => productController.getProductById(req, res, next));
